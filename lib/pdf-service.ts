...
export async function generateReportPDF(
  ...
  try {
    ...
    // Branded footer section at the bottom
    const brandedFooterY = pageHeight - 20

    // Footer separator line for branding
    pdf.setLineWidth(0.5)
    pdf.setDrawColor(229, 231, 235) // gray-200
    pdf.line(margin, brandedFooterY - 5, pageWidth - margin, brandedFooterY - 5)
    ...
    pdf.text("Generated by OH Plus Platform", margin, brandedFooterY)

    // Right side - branding
    pdf.text("Smart. Seamless. Scalable.", pageWidth - margin - 80, brandedFooterY)
    pdf.setFont("helvetica", "bold")
    pdf.setTextColor(0, 150, 200) // OH+ brand color
    pdf.text("OH+", pageWidth - margin - 15, brandedFooterY)
