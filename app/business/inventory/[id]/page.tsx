            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center">
                  ...
                  <span className="text-lg font-medium text-green-700">₱{Number(product.price).toLocaleString()}</span>
                </div>
                <div className="flex items-center">
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700">
                    Created:{" "}
                    {product.created_at ? new Date(product.created_at.seconds * 1000).toLocaleDateString() : "Unknown"}
                  </span>
                </div>
              </div>
            </CardContent>
