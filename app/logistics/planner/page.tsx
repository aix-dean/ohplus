...
export default function LogisticsPlannerPage() {
  ...
  const fetchEvents = useCallback(async () => {
    try {
      const fetchedEvents = await getSalesEvents(false, "logistics", userData?.company_id || undefined)
  ...
  const fetchTodos = useCallback(async () => {
    ...
    try {
      const fetchedTodos = await getTodosByUser("", userData.company_id, "logistics")
