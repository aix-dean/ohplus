...
export default function TeamDetailsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 md:p-6 lg:p-8" style={{ marginTop: '-32px' }}>
      {/* Header */}
          ...
          <div className="flex items-start justify-between">
            <div className="flex items-start gap-6">
              ...
              <div className="w-16 h-16 bg-gray-200 rounded-full flex items-center justify-center">
                <img
                  src="/icons/crew-card-avatars/avatar1.svg"
              ...
              {/* Team Details */}
              <div>
                <p><span className="font-semibold text-gray-700">Crew Name:</span> <span className="font-normal text-gray-700">{team.name}</span></p>
                <p><span className="font-semibold text-gray-700">Crew Head:</span> <span className="font-normal text-gray-700">{team.leaderName || 'No Leader'}</span></p>
                <p><span className="font-semibold text-gray-700">Contact Number:</span> <span className="font-normal text-gray-700">{team.contactNumber || 'N/A'}</span></p>
                <p><span className="font-semibold text-gray-700">Added On:</span> <span className="font-normal text-gray-700">{new Date(team.createdAt || Date.now()).toLocaleDateString()}</span></p>
              </div>
            </div>
