...
// Removed getProductById as product details will be in quotation.items
...
export default function QuotationDetailsPage() {
  ...
  // Removed product state as it's no longer needed for single product display
    ...
    async function fetchQuotationDetails() {
      if (params.id) {
        try {
          ...
          setEditableQuotation(quotationData)
        } catch (error) {
  ...
  const handleSaveEdit = async () => {
    ...
    setIsSaving(true)
    try {
      const currentUserId = "current_user_id" // Replace with actual user context
      const currentUserName = "Current User" // Replace with actual user context
  ...
  const handleEmailOptionClick = () => {
    setIsSendQuotationOptionsDialogOpen(false)
        ...
        <div className="max-w-[850px] bg-white shadow-md rounded-sm overflow-hidden">
          ...
          <div className="p-6 sm:p-8">
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p className="text-base text-gray-900">{formatDateDisplay(quotation.created)}</p>
                </div>
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <p className="text-base text-gray-900">{formatDateDisplay(quotation.valid_until)}</p>
                  )}
                </div>
                <div>
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    {quotation.items.map((item, index) => (
                      <tr key={item.product_id || index} className="bg-white">
                        <td className="py-3 px-4 border-b border-gray-200">
                          <div className="font-medium text-gray-900">{safeString(item.product_name)}</div>
                        ...
                        <td className="py-3 px-4 border-b border-gray-200">{safeString(item.product_location)}</td>
                        ...
                        <td className="py-3 px-4 text-right border-b border-gray-200">
                          <div className="font-medium text-gray-900">{safeString(item.duration_days)}</div>
                        </td>
                        <td className="py-3 px-4 text-right border-b border-gray-200">
            ...
            <div className="mt-12 pt-6 border-t border-gray-200 text-center text-xs text-gray-500">
              <p>This quotation is valid until {formatDateDisplay(quotation.valid_until)}</p>
