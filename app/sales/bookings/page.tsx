                  ...
                  <TableBody>
                    {bookings.map((booking) => (
                      ...
                      >
                        ...
                        <TableCell className="py-3">₱{booking.total_amount?.toLocaleString() || "N/A"}</TableCell>
                        <TableCell className="py-3">
...
\
          ...
          <p className="text-center py-10 text-gray-600">Please log in to view your bookings.</p>
        )}
      </div>
  \
