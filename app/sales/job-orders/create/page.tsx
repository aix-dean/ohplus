    ...
    try {
      const jobOrdersData = products.map((product, index) => {
        ...
        return {
          ...
          siteCode: item?.site_code || product.site_code || product.specs_rental?.site_code || product.light?.site_code || "N/A",
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[calc(100vh-64px)] p-4 text-center">
        ...
        <p className="text-gray-600 mb-4">
          The selected quotation or its associated products could not be loaded.
        </p>
                    ...
                    <div key={product.id} className="flex items-center gap-2 p-1.5 bg-gray-100 rounded-md">
                      ...
                      <div className="flex-1">
                        <p className="font-semibold text-sm">
                          {item?.site_code || product.site_code || product.specs_rental?.site_code || product.light?.site_code || "N/A"}
                        </p>
                    ...
                    <Card>
                      ...
                      <CardContent className="space-y-4">
                        ...
                        <div className="space-y-2">
                          ...
                          >
                            {form.uploadingAttachment ? <Loader2 className="h-6 w-6 animate-spin" /> : <Plus className="h-6 w-6" />}
