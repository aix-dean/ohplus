...
export default function TreasuryPlannerPage() {
  ...
  const fetchEvents = useCallback(async () => {
    try {
      const fetchedEvents = await getSalesEvents(false, "treasury", userData?.company_id || undefined)
  ...
  const fetchTodos = useCallback(async () => {
    ...
    try {
      const fetchedTodos = await getTodosByUser("", userData.company_id, "treasury")
