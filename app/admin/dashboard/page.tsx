...
import { Plus, ArrowUpRight, CreditCard, DollarSign, Users, Activity, ArrowRight, MessageSquare } from "lucide-react"
      ...
      <div className="flex flex-col gap-4 p-4 md:gap-8 md:p-6">
        ...
        <Card>
          ...
          <CardContent className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <Button variant="outline" className="justify-between bg-transparent">
              View Chat Analytics <ArrowRight className="h-4 w-4" />
            </Button>
            <Button variant="outline" className="justify-between bg-transparent">
              Update User Roles <ArrowRight className="h-4 w-4" />
            </Button>
          </CardContent>
        </Card>
      </div>
