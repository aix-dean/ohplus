...
import { ArrowRightIcon, DollarSignIcon, UsersIcon } from "lucide-react"
...
export default function DashboardPage() {
  ...
  useEffect(() => {
    if (searchParams.get("registered") === "true") {
      ...
      // Remove the query parameter to prevent the dialog from showing again on refresh
            ...
            <Table>
              ...
              <TableBody>
                ...
                <TableRow>
                  ...
                  <TableCell className="hidden md:table-column">2023-06-24</TableCell>
                ...
                <TableRow>
                  ...
                  <TableCell className="hidden md:table-column">2023-06-25</TableCell>
                ...
                <TableRow>
                  ...
                  <TableCell className="hidden md:table-column">2023-06-26</TableCell>
...
import { CreditCardIcon, ActivityIcon } from "lucide-react"
