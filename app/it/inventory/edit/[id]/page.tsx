...
export default function EditInventoryItemPage() {
  ...
  useEffect(() => {
    ...
    const loadData = async () => {
      ...
      const mockData: FormData = {
        ...
        specifications: "Intel i7-11700, 16GB DDR4 RAM, 512GB NVMe SSD, Intel UHD Graphics",
  ...
  const handleSubmit = async () => {
    ...
    router.push("/it/inventory?success=updated")
  }
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="text-center">
              ...
              <p className="mt-1 text-sm text-muted-foreground">The inventory item you're looking for doesn't exist.</p>
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Update the details of {formData.name}</p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {currentStep === 1 && "Update the basic information about the inventory item"}
            {currentStep === 2 && "Modify detailed specifications and description"}
            {currentStep === 3 && "Update purchase and financial information"}
            {currentStep === 4 && "Review all changes before saving"}
          </CardDescription>
        </CardHeader>
