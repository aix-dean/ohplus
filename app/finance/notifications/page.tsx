...
export default function FinanceNotificationsPage() {
  const { notifications, loading } = useFinanceNotifications()
  ...
  return (
    <div className="flex-1 overflow-auto">
      <header className="flex justify-between items-center p-4 border-b border-gray-200">
        <div>
          <h1 className="text-xl font-bold">Finance Notifications</h1>
          <p className="text-sm text-gray-500">All finance notifications</p>
        </div>
      </header>
            ...
            {notifications.map((notification) => (
              <Card
                ...
                className={`cursor-pointer hover:shadow-md transition-shadow ${
                  !notification.viewed ? "border-green-200 bg-green-50" : ""
                }`}
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center justify-between mt-2">
                        ...
                        <span className="text-xs text-green-600">{notification.type}</span>
                      </div>
                    </div>
                  </div>
                </CardContent>
