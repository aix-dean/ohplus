...
export default function CreateFinanceCollectiblePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log("Finance collectible created with ID:", docRef.id)

      router.push("/finance/collectibles")
    } catch (error) {
      console.error("Error creating finance collectible:", error)
      setSubmitError("Failed to create finance collectible. Please try again.")
    } finally {
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex justify-end gap-4 pt-4">
              ...
              <Button type="submit" disabled={isSubmitting}>
                {isSubmitting ? "Creating..." : "Create Finance Collectible"}
              </Button>
            </div>
          </form>
        </CardContent>
