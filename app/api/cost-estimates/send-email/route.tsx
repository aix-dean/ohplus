...
export async function POST(request: NextRequest) {
  try {
    ...
    if (!costEstimate || !clientEmail) {
      ...
      return NextResponse.json({ error: "Missing cost estimate or client email address" }, { status: 400 })
    }
    ...
    const finalBody =
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <div class="cost-estimate-summary">
              ...
              <div class="summary-item">
                ...
                <span class="summary-value">${costEstimate.title || "Custom Advertising Cost Estimate"}</span>
              </div>
              <div class="summary-item">
              ...
              <div class="summary-item">
                ...
                <span class="summary-value">${costEstimate.validUntil ? new Date(costEstimate.validUntil).toLocaleDateString() : new Date(Date.now() + 30 * 24 * 60 * 60 * 1000).toLocaleDateString()}</span>
              </div>
            </div>
          ...
          <div class="footer">
            <p>This cost estimate is confidential and intended solely for ${costEstimate.client?.company || "your company"}.</p>
