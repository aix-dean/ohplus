  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle className="text-[#000000]">Petty Cash Configuration</DialogTitle>
        </DialogHeader>

        <div className="space-y-6">
          <div>
            <label className="block text-lg font-medium text-[#000000] mb-3">
              Petty Cash Amount:
            </label>
            <Input
              type="text"
              ...
              className="w-full border-[#c4c4c4] bg-[#fafafa] text-[#000000]"
              placeholder="10,000"
            />
          ...
          <div className="text-sm text-[#a1a1a1] bg-[#f9f9f9] p-3 rounded-md">
        ...
        <DialogFooter className="gap-2">
          <Button
            variant="outline"
            onClick={handleClose}
            className="border-[#c4c4c4] text-[#000000] bg-transparent hover:bg-[#fafafa]"
          >
            Cancel
          </Button>
          <Button
            ...
            disabled={isLoading}
            className="bg-[#737fff] hover:bg-[#5a5fff] text-white disabled:opacity-50 disabled:cursor-not-allowed"
          >
