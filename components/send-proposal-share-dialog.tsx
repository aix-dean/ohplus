...
import { Mail, MessageCircle, Phone, Send, Eye } from "lucide-react"
import { useToast } from "@/hooks/use-toast"
import { useRouter } from "next/navigation"
import type { Proposal } from "@/lib/types/proposal"
import { ProposalViewerDialog } from "./proposal-viewer-dialog"
...
export function SendProposalShareDialog({ isOpen, onClose, proposal }: SendProposalShareDialogProps) {
  ...
  return (
    <>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="flex-1">
                ...
                <Button
                  ...
                  variant="ghost"
                  size="sm"
                  className="mt-2 h-7 px-2 text-xs text-blue-600 hover:text-blue-700 hover:bg-blue-50"
                >
      ...
      <ProposalViewerDialog isOpen={isViewerOpen} onClose={() => setIsViewerOpen(false)} proposal={proposal} />
    </>
  )
}
