...
export function SalesNotifications() {
  const { notifications, loading, unreadCount } = useSalesNotifications()
  ...
  if (loading) {
    return (
      <div className="bg-gradient-to-br from-red-300 to-red-400 rounded-lg p-3 text-white">
        <div className="flex items-center justify-between mb-3">
          <h3 className="text-sm font-medium">Sales Notifications</h3>
          {unreadCount > 0 && (
