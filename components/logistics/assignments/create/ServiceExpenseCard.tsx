      ...
      <CardContent className="grid gap-4">
        <div className="flex items-center space-x-2">
          <div className="grid flex-1 gap-2">
            ...
            <Input id="crewFee" placeholder="Enter amount" />
          </div>
        ...
        <div className="flex items-center space-x-2">
          <div className="grid flex-1 gap-2">
            ...
            <Input id="overtimeFee" placeholder="Enter amount" />
          </div>
          <Button variant="ghost" size="sm" className="mt-7">X</Button>
        </div>
        ...
        <div className="flex items-center space-x-2">
          <div className="grid flex-1 gap-2">
            ...
            <Input id="transpo" placeholder="Enter amount" />
          </div>
          <Button variant="ghost" size="sm" className="mt-7">X</Button>
        </div>
        ...
        <div className="flex items-center space-x-2">
          <div className="grid flex-1 gap-2">
            ...
            <Input id="tollFee" placeholder="Enter amount" />
          </div>
          <Button variant="ghost" size="sm" className="mt-7">X</Button>
        </div>
        ...
        <div className="flex items-center space-x-2">
          <div className="grid flex-1 gap-2">
            ...
            <Input id="mealAllowance" placeholder="Enter amount" />
          </div>
          <Button variant="ghost" size="sm" className="mt-7">X</Button>
        </div>
        ...
        <div className="flex justify-between items-center mt-4">
          <span className="text-lg font-bold">Total: P 0.00</span>
