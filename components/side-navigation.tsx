      ...
      <nav className="p-3 space-y-4">
        {currentSection === "cms" ? (
          ...
          <>
            ...
            <div className="bg-white rounded-lg border border-gray-200 shadow-sm">
              <div className="px-3 py-2 border-b border-gray-100">
                <h3 className="text-sm font-medium text-gray-700">Intelligence</h3>
              </div>
              <div className="p-1">
                {[
                  { title: "AI Assistant", href: "/ai-assistant", icon: Bot },
                  { title: "Analytics", href: "/treasury/analytics", icon: BarChart3 },
                  { title: "Insights", href: "/treasury/insights", icon: Lightbulb },
                ].map((item) => {
                  const Icon = item.icon
                  const active = isActive(pathname, item.href)
                  return (
