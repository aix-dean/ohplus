...
import { LayoutDashboard, Users, Calendar, BarChart3, Truck, AlertTriangle, FileText, Settings, ShieldCheck, BookOpen, Package, MessageCircle, FileCheck, Sparkles, ChevronLeft, ChevronRight, TrendingUp, ClipboardList, CloudRain, Cog, Monitor, Wifi, HardDrive, DollarSign, PieChart, CreditCard, Calculator } from 'lucide-react'
...
const navigationItems = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Transactions", href: "/finance/transactions", icon: FileText },
            ...
            <div className="bg-white rounded-lg border border-gray-200 shadow-sm">
              ...
              <div className="p-1">
                {[
                  ...
                  { title: "Budget Planning", href: "/finance/budget", icon: PieChart },
                  { title: "Payments", href: "/finance/payments", icon: CreditCard },
                  { title: "Invoicing", href: "/finance/invoicing", icon: FileText },
                  { title: "Tax Management", href: "/finance/tax", icon: Calculator },
